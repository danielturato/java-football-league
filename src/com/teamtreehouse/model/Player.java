...
public class Player implements Comparable<Player>, Serializable {
  ...
  public String toString() {
    return String.format("Name : %s %s, Height : %d, Experiance : %b", firstName, lastName, heightInInches, previousExperience);
  }

  public static Comparator<Player> playerHeightComparator = new Comparator<Player>() {

    public int compare(Player p1, Player p2) {
      Integer height1 = p1.getHeightInInches();
      Integer height2 = p2.getHeightInInches();
